...
DEFAULT_FONTS_DIR = os.path.join(SCRIPT_PATH, 'fonts6')
...
def generate_hangul_images(label_file, fonts_dir, output_dir):
    ...
    labels_csv = io.open(os.path.join(output_dir, 'labels-map.csv'), 'a',
                         encoding='utf-8-sig')
    ...
    for character in labels:
        ...
        for font in fonts:
            ...
            file_string = 'hangul_{}.jpeg'.format(total_count + 940000)
